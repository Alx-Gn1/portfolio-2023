  ...
  return (
    <section id="about" className={styles.mainContainer} ref={parallax.ref}>
      <article className={styles.contentContainer}>
        <img src={photoOfMyself} alt="Portrait Alexandre Guenin" className={styles.tabletPicture} />
        <h2>{t("about.title")}</h2>
      ...
      <img src={photoOfMyself} alt="Portrait Alexandre Guenin" className={styles.pictureOfMe} />
    </section>
  );
};
